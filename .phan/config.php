...
return [
    ...
    // Baseline: absorb pre-existing issues so only new findings fail CI.
    // Regenerate with `vendor/bin/phan --save-baseline=.phan/baseline.php`.
    ...
    //
    // The php-stubs directories are parsed (for WordPress signatures) but not
    // analyzed — they sit in `exclude_analysis_directory_list` above. Remaining
    // PHP classes (e.g. PHPUnit\Framework\TestCase) resolve via the composer
    // autoloader Phan loads from vendor/.
    'directory_list' => [
        'functions',
        'includes',
        'stubs',
        ...
        // Test base classes: WP_UnitTestCase_Base -> PHPUnit_Adapter_TestCase
        // -> Yoast\PHPUnitPolyfills\TestCases\TestCase -> PHPUnit\Framework\TestCase.
        'vendor/phpunit/phpunit/src',
        'vendor/yoast/phpunit-polyfills/src',
    ],
